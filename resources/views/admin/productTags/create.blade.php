    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.product-tags.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('tag_link') ? 'is-invalid' : '' }}" type="text" name="tag_link" id="tag_link" value="{{ old('tag_link', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('tag_title') ? 'is-invalid' : '' }}" type="text" name="tag_title" id="tag_title" value="{{ old('tag_title', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('tag_alt') ? 'is-invalid' : '' }}" type="text" name="tag_alt" id="tag_alt" value="{{ old('tag_alt', '') }}">
