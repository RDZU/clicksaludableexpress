<div id="sidebar" class="c-sidebar c-sidebar-fixed c-sidebar-lg-show">
    ...
    <ul class="c-sidebar-nav">
        ...
        @can('product_management_access')
            <li class="c-sidebar-nav-dropdown {{ request()->is("admin/product-categories*") ? "c-show" : "" }} {{ request()->is("admin/product-tags*") ? "c-show" : "" }} {{ request()->is("admin/products*") ? "c-show" : "" }} {{ request()->is("admin/marcas*") ? "c-show" : "" }}">
                <a class="c-sidebar-nav-dropdown-toggle" href="#">
                    ...
                    @can('marca_access')
                        <li class="c-sidebar-nav-item">
                            <a href="{{ route("admin.marcas.index") }}" class="c-sidebar-nav-link {{ request()->is("admin/marcas") || request()->is("admin/marcas/*") ? "c-active" : "" }}">
                                <i class="fa-fw fab fa-medium c-sidebar-nav-icon">
        ...
        @can('contacto_access')
            <li class="c-sidebar-nav-item">
                <a href="{{ route("admin.contactos.index") }}" class="c-sidebar-nav-link {{ request()->is("admin/contactos") || request()->is("admin/contactos/*") ? "c-active" : "" }}">
