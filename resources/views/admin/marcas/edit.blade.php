    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.marcas.update", [$marca->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('descripcion') ? 'is-invalid' : '' }}" name="descripcion" id="descripcion">{{ old('descripcion', $marca->descripcion) }}</textarea>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('image_link') ? 'is-invalid' : '' }}" type="text" name="image_link" id="image_link" value="{{ old('image_link', $marca->image_link) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('image_title') ? 'is-invalid' : '' }}" type="text" name="image_title" id="image_title" value="{{ old('image_title', $marca->image_title) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('image_alt') ? 'is-invalid' : '' }}" type="text" name="image_alt" id="image_alt" value="{{ old('image_alt', $marca->image_alt) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('slug') ? 'is-invalid' : '' }}" type="text" name="slug" id="slug" value="{{ old('slug', $marca->slug) }}">
                @if($errors->has('slug'))
                    <div class="invalid-feedback">
                        {{ $errors->first('slug') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <select class="form-control {{ $errors->has('visible_home') ? 'is-invalid' : '' }}" name="visible_home" id="visible_home">
                    ...
                    @foreach(App\Models\Marca::VISIBLE_HOME_SELECT as $key => $label)
                        <option value="{{ $key }}" {{ old('visible_home', $marca->visible_home) === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
