    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.products.update", [$product->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('marca') ? 'is-invalid' : '' }}" name="marca_id" id="marca_id" required>
                    @foreach($marcas as $id => $marca)
                        <option value="{{ $id }}" {{ (old('marca_id') ? old('marca_id') : $product->marca->id ?? '') == $id ? 'selected' : '' }}>{{ $marca }}</option>
                    @endforeach
                </select>
                @if($errors->has('marca'))
                    <div class="invalid-feedback">
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('etiquetas') ? 'is-invalid' : '' }}" name="etiquetas[]" id="etiquetas" multiple>
                    @foreach($etiquetas as $id => $etiquetas)
                        <option value="{{ $id }}" {{ (in_array($id, old('etiquetas', [])) || $product->etiquetas->contains($id)) ? 'selected' : '' }}>{{ $etiquetas }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('tipo_presentacion') ? 'is-invalid' : '' }}" type="text" name="tipo_presentacion" id="tipo_presentacion" value="{{ old('tipo_presentacion', $product->tipo_presentacion) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('envase') ? 'is-invalid' : '' }}" type="text" name="envase" id="envase" value="{{ old('envase', $product->envase) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('cantidad') ? 'is-invalid' : '' }}" type="text" name="cantidad" id="cantidad" value="{{ old('cantidad', $product->cantidad) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('largo') ? 'is-invalid' : '' }}" type="number" name="largo" id="largo" value="{{ old('largo', $product->largo) }}" step="1" required>
                @if($errors->has('largo'))
                    <div class="invalid-feedback">
                        {{ $errors->first('largo') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('ancho') ? 'is-invalid' : '' }}" type="number" name="ancho" id="ancho" value="{{ old('ancho', $product->ancho) }}" step="1" required>
                @if($errors->has('ancho'))
                    <div class="invalid-feedback">
                        {{ $errors->first('ancho') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('alto') ? 'is-invalid' : '' }}" type="number" name="alto" id="alto" value="{{ old('alto', $product->alto) }}" step="1" required>
                @if($errors->has('alto'))
                    <div class="invalid-feedback">
                        {{ $errors->first('alto') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('peso') ? 'is-invalid' : '' }}" type="text" name="peso" id="peso" value="{{ old('peso', $product->peso) }}" required>
                @if($errors->has('peso'))
                    <div class="invalid-feedback">
                        {{ $errors->first('peso') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <select class="form-control {{ $errors->has('visible_home') ? 'is-invalid' : '' }}" name="visible_home" id="visible_home">
                    ...
                    @foreach(App\Models\Product::VISIBLE_HOME_SELECT as $key => $label)
                        <option value="{{ $key }}" {{ old('visible_home', $product->visible_home) === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('descripcion_home') ? 'is-invalid' : '' }}" type="text" name="descripcion_home" id="descripcion_home" value="{{ old('descripcion_home', $product->descripcion_home) }}">
            ...
            <div class="form-group">
                ...
                <select class="form-control {{ $errors->has('stock') ? 'is-invalid' : '' }}" name="stock" id="stock">
                    ...
                    @foreach(App\Models\Product::STOCK_SELECT as $key => $label)
                        <option value="{{ $key }}" {{ old('stock', $product->stock) === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
                @if($errors->has('stock'))
                    <div class="invalid-feedback">
        ...
        -->
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('image_frontal_link') ? 'is-invalid' : '' }}" type="text" name="image_frontal_link" id="image_frontal_link" value="{{ old('image_frontal_link', $product->image_frontal_link) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('image_frontal_title') ? 'is-invalid' : '' }}" type="text" name="image_frontal_title" id="image_frontal_title" value="{{ old('image_frontal_title', $product->image_frontal_title) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('image_frontal_alt') ? 'is-invalid' : '' }}" type="text" name="image_frontal_alt" id="image_frontal_alt" value="{{ old('image_frontal_alt', $product->image_frontal_alt) }}">
        ...
        <div class="form-group">
            <label>{{ trans('cruds.product.fields.photo_min_frontal_link') }}</label>
            <select class="form-control {{ $errors->has('photo_min_frontal_link') ? 'is-invalid' : '' }}" name="photo_min_frontal_link" id="photo_min_frontal_link">
                ...
                @foreach(App\Models\Product::PHOTO_MIN_FRONTAL_LINK_SELECT as $key => $label)
                    <option value="{{ $key }}" {{ old('photo_min_frontal_link', $product->photo_min_frontal_link) === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                @endforeach
            </select>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('image_reverso_link') ? 'is-invalid' : '' }}" type="text" name="image_reverso_link" id="image_reverso_link" value="{{ old('image_reverso_link', $product->image_reverso_link) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('image_reverso_title') ? 'is-invalid' : '' }}" type="text" name="image_reverso_title" id="image_reverso_title" value="{{ old('image_reverso_title', $product->image_reverso_title) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('image_reverso_alt') ? 'is-invalid' : '' }}" type="text" name="image_reverso_alt" id="image_reverso_alt" value="{{ old('image_reverso_alt', $product->image_reverso_alt) }}">
        ...
        -->
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('photo_min_reverso_link') ? 'is-invalid' : '' }}" type="text" name="photo_min_reverso_link" id="photo_min_reverso_link" value="{{ old('photo_min_reverso_link', $product->photo_min_reverso_link) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('photo_link_reverso_title') ? 'is-invalid' : '' }}" type="text" name="photo_link_reverso_title" id="photo_link_reverso_title" value="{{ old('photo_link_reverso_title', $product->photo_link_reverso_title) }}">
...
<!--
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('photo_link_reverso_alt') ? 'is-invalid' : '' }}" type="text" name="photo_link_reverso_alt" id="photo_link_reverso_alt" value="{{ old('photo_link_reverso_alt', $product->photo_link_reverso_alt) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('photo_min_frontal_link') ? 'is-invalid' : '' }}" type="text" name="photo_min_frontal_link" id="photo_min_frontal_link" value="{{ old('photo_min_frontal_link', $product->photo_min_frontal_link) }}">
                @if($errors->has('photo_min_frontal_link'))
                    <div class="invalid-feedback">
                        {{ $errors->first('photo_min_frontal_link') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('photo_link_frontal_title') ? 'is-invalid' : '' }}" type="text" name="photo_link_frontal_title" id="photo_link_frontal_title" value="{{ old('photo_link_frontal_title', $product->photo_link_frontal_title) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('photo_link_frontal_alt') ? 'is-invalid' : '' }}" type="text" name="photo_link_frontal_alt" id="photo_link_frontal_alt" value="{{ old('photo_link_frontal_alt', $product->photo_link_frontal_alt) }}">
